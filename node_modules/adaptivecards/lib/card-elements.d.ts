...
import { HostConfig, FontTypeDefinition, ColorSetDefinition, TextColorDefinition, ContainerStyleDefinition } from "./host-config";
...
declare class ImageDimensionProperty extends PropertyDefinition {
    ...
    constructor(targetVersion: Version, name: string, internalName: string);
}
...
export declare class InputValidationOptions extends SerializableObject {
    static readonly necessityProperty: EnumProperty<typeof Enums.InputValidationNecessity>;
...
export declare abstract class Input extends CardElement implements IInput {
    static readonly validationProperty: SerializableObjectProperty;
    protected populateSchema(schema: SerializableObjectSchema): void;
