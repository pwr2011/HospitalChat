...
export declare abstract class BaseSerializationContext {
    ...
    clearEvents(): void;
    logEvent(phase: Enums.ValidationPhase, event: Enums.ValidationEvent, message: string, source?: SerializableObject): void;
    logParseEvent(event: Enums.ValidationEvent, message: string, source?: SerializableObject): void;
...
export declare class SerializableObjectProperty extends PropertyDefinition {
    ...
    constructor(targetVersion: Version, name: string, objectType: SerializableObjectType);
}
